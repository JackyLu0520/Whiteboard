...
pygame.display.set_caption("Whiteboard 2.1")
radins = 15
mousedown = False
UnFinished = True
white = 255, 255, 255
...
screen.blit(font.render("Save", 1, white), [982, 18])
pygame.draw.rect(screen, black, (1075, 0, 50, 50), 0)
screen.blit(font.render("Open", 1, white), [1082, 18])
pygame.draw.rect(screen, black, (1175, 0, 50, 50), 0)
screen.blit(font.render("New", 1, white), [1185, 18])
